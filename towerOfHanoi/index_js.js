...
divC3.setAttribute('class',"container");
let divC4=document.createElement('div');
divC4.setAttribute('class',"container");
...
divD1.setAttribute('class',"tank");
divD.append(divD1);
let divD2=document.createElement('div');
divD2.setAttribute('class',"container");
divD1.append(divD2);
...
divD3.setAttribute('class',"container");
let divD4=document.createElement('div');
divD4.setAttribute('class',"container");
